...
let closing = ["Our platform is secured and convenient to use"]
...
function chatbotvoice(message){
    ...
    speech.text = "I cannot understand your query , you can mail your queries at rajanp2311@gmail.com , regards cookie bot.";
    ...
    if(message.includes('hello' || 'hi' || 'Anyone here to assist me ?')){
    ...
    if(message.includes('platform security' )){
